...
export const HomePage: React.FC<HomePageProps> = ({ agencies }) => {
  ...
  const [chatHistory, setChatHistory] = useState<ChatMessage[]>([
    {
      role: 'model',
      content: "Halo! Saya asisten virtual MPP Pandeglang. Anda bisa bertanya tentang syarat, alur, atau biaya layanan. Contoh: 'syarat buat SKCK' atau 'jam buka mpp pandeglang'."
    }
  ]);
